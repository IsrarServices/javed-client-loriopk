...
import { a as products, i as getProduct, r as WHATSAPP_NUMBER } from "./cart-Bdzj7kz4.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as Sparkles, h as Leaf, r as Truck, s as ShieldCheck } from "../_libs/lucide-react.mjs";
import { n as SiteLayout, t as Button } from "./site-layout-CTW8j8s9.mjs";
import { t as ProductCard } from "./product-card-ChaGUL4C.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-cX0rmjeA.js
var import_jsx_runtime = require_jsx_runtime();
var STORY_IMAGE_SLUGS = ["jasmine-scent", "pink-rose-glow"];
function Home() {
	const storyImages = STORY_IMAGE_SLUGS.map(getProduct).filter(Boolean);
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					children: storyImages.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
